...
emcp=3
mcp    = CoucheConductriceCylindrique(  0.2,  880 , 2000, 40.5e-3,  (40.5+emcp)*10**-3, T0)  #On choisit le MCP RT15 pour usage rosé
plast2 = CoucheConductriceCylindrique( 0.26, 1200 , 1500,   (40.5+emcp)*10**-3,(40.5+emcp+0.5)*10**-3, T0)
revet2 = CoucheConductriceCylindrique(0.192, 1230 , 2176, (40.5+emcp+0.5)*10**-3,  (40.5+emcp+0.5+0.5)*10**-3, T0)
...
for hvin in [100,200,300,400,500,600,700,800,900]:
    eta_vin = hvin # Pour pouvoir être utilisé plus bas
...
## 6 - Visualisation des résultats
    ...
    ax_T.plot(tmn_NL,soluNonLin[:,0],label='T° Vin Non linéaire avec hvin='+str(hvin))
    print(emcp)
